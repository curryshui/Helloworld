...
<form name="form1" method="post" action="return_result.php" onsubmit="return checksearch()">
  <table width="60%" border="0" cellspacing="1" cellpadding="3" align="center">
<tr>
  <th>
<body style="background-image:url('img/010.jpg');background-position:center; background-repeat:repeat-y;">
    <tr> 
